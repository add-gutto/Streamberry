...
SECRET_KEY = "django-insecure-za7!e2_#ryr#6l%blmq!cq&yakh6uccm_i)^-zi+!(ldwsh$_y"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'genero.context_processors.generos_disponiveis',
            ],
        },
    },
]

WSGI_APPLICATION = "streamberry.wsgi.application"
